...
app.controller('saleCtrl', ['$scope', '$state', '$stateParams', '$modal', '$log', 'Sale', function ($scope, $state, $stateParams, $modal, $log, Sale) {
